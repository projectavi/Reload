...
MAX_LOSS = 1E8
def CU_k(data_loaders, model, criterion, optimizer, epoch, args, mask=None, wandb_run=None):
    ...
    args.unlearn_epochs = 31

    model = resetFinalResnet(model, K, args.arch, None, reinit=False)  # Turns parameters to freeze off, reinitializes rest
